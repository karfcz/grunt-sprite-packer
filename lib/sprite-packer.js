...
SpritePacker.prototype = {
	...
	createCss: function()
	{
		...
		var templateSource = fs.readFileSync(this.options.templateFile, 'utf8');
		var template = Handlebars.compile(templateSource);
		var result = template(tplData);

		fs.writeFile(this.options.outCss, result, 'utf8', this.createCssDone.bind(this));
	},

	convertDone: function()
	{
		console.log('File ' + this.options.outfile + ' created.');
	...
	{
		console.log('File ' + this.options.outCss + ' created.');
